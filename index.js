...
async function run() {
    try {
        ...
        const availableDonorCollection = client.db("bloodDonation").collection("available-donor");
        const userPostCollection = client.db("bloodDonation").collection("allPosts");
        const userCommentCollection = client.db("bloodDonation").collection("allComments");
        // User api
        ...
        app.get("/available-donor", async (req, res) => {
            const filter = req.query;
            const { blood = "", religious = "", division = "",district="",area="" } = filter;
